export const band = {
  ...
  spotifyEmbed:
    'https://open.spotify.com/embed/artist/7tPoZvl7OYT2rQDdzCQpfR?utm_source=generator&theme=0',
  albums: [
  ...
  bio: `Swagger was formed by Rick Butler in 2007 when he moved from California to Utah bringing his love of Irish music. Along with a local fiddler Dennis Harrington from Chicago, he put together a group of local musicians to form the band. Swagger played their first pub show at the Piper Down on April 24th, 2007. The match was lit and the band took off. Swagger has been honing their original brand of Celtic music at festivals and concert halls across the United States ever since. Well known for their high-energy stage performances and catchy original songs, Swagger's music is the expected Irish celebration of drink, mischief, and music, which also dares to explore oppression and take an emigrant's perspective on the virtues and vices of the Irish-American culture. Along the way, the band has shared the stage with such groups as The Young Dubliners, The English Beat, The Clumsy Lovers, Howard Jones, Brother, Albanach, Andy Frasco, just to name a few. In 2010 Swagger assembled Utah's first Irish Music Festival at Deer Valley in front of 5,000 new fans of the band. After 3 years of hosting their own Irish festival, the band hit the road performing at festivals along the west coast.
